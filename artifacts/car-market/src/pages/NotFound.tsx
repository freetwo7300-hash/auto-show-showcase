    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-gradient-to-br from-background via-muted/30 to-background">
      <div className="text-center max-w-md">
        ...
        <div className="flex gap-3 justify-center mt-8">
          <Button asChild><Link href="/"><Home className="w-4 h-4 ml-1" /> الرئيسية</Link></Button>
          <Button asChild variant="outline"><Link href="/cars"><Car className="w-4 h-4 ml-1" /> السيارات</Link></Button>
        </div>
      </div>
    </div>
  );
